...
Based on `{{SKILLS_DIR}}/hooks-framework/hooks.yaml` template, generate project-customized hooks configuration:
...
- [ ] `{{AGENTS_DIR}}/` — 7 agent definition files
- [ ] `{{SKILLS_DIR}}/` — Standard skill packages
