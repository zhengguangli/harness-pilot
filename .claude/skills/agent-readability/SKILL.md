...
description: Optimize code/docs for agent readability. Help AI agents reason about business domains from repo. Triggers on "智能体可读性", "agent readability", "优化可读性", "让智能体看懂".
---
