---
name: web-search
description: Web search integration. Query latest docs, version info, real-time data beyond training cutoff. Triggers on "搜索", "查一下", "web search", "联网搜索", "上网搜". Do NOT use for finding project tools.
---
...
- Cache search results to `.workspace/search_cache/` (TTL: 1 hour)
