...
- Agent definitions: `{{AGENTS_DIR}}/` — 7 specialized agents
- Skill definitions: `{{SKILLS_DIR}}/` — 14 standard skills
...
- Architecture design? Read `{{AGENTS_DIR}}/architect.md`
- Quality review? Read `{{SKILLS_DIR}}/quality-gate/SKILL.md`
- Knowledge management? Read `{{SKILLS_DIR}}/context-setup/SKILL.md`
- Evolution feedback? Read `{{SKILLS_DIR}}/harness-evolve/SKILL.md`
- Hooks config? Read `{{SKILLS_DIR}}/hooks-framework/SKILL.md`
- Web search? Read `{{SKILLS_DIR}}/web-search/SKILL.md`
- MCP integration? Read `{{SKILLS_DIR}}/mcp-connector/SKILL.md`
